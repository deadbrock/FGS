...
export const MudancaRisco: React.FC = () => {
  useNavigationLog();
  ...
  const carregarDados = async () => {
    try {
      ...
      const [solicitacoesData, clinicasData] = await Promise.all([
        solicitacoesService.getAll({ tipo_exame: 'MUDANCA_RISCO' }),
  ...
  return (
    <Box>
      <PageHeader
        ...
        subtitle="Gestão de exames por mudança de função ou risco ocupacional"
        breadcrumbs={[
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>Cargo Anterior</TableCell>
                  <TableCell>Cargo Novo</TableCell>
                ...
                {solicitacoes.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={8} align="center" sx={{ py: 4 }}>
                      <Typography color="text.secondary">
                        Nenhuma solicitação de mudança de risco encontrada
                      </Typography>
                    </TableCell>
                  </TableRow>
                ) : (
                  solicitacoes.map((solicitacao) => (
                    <TableRow key={solicitacao.id} hover>
                      ...
                      <TableCell>{solicitacao.cargo_anterior || '-'}</TableCell>
      ...
      <Dialog open={dialogNovaAberto} onClose={() => setDialogNovaAberto(false)} maxWidth="md" fullWidth>
        <DialogTitle>Nova Solicitação de Mudança de Risco</DialogTitle>
        <DialogContent>
          <Grid container spacing={2} sx={{ mt: 1 }}>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                value={formNova.cargo_anterior}
                onChange={(e) => setFormNova({ ...formNova, cargo_anterior: e.target.value })}
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <TextField
            ...
            <Grid item xs={12}>
              <TextField
                ...
                placeholder="Descreva as mudanças de risco ou função"
              />
            </Grid>
          </Grid>
        </DialogContent>
